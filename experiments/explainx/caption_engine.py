...
from transformers.generation_utils import (
    BeamScorer, LogitsProcessorList, BeamSearchOutput, SampleOutput
)
...
class MixtureGenerationMixin(transformers.generation_utils.GenerationMixin):
...
class ContrastiveGenerationMixin(transformers.generation_utils.GenerationMixin):
