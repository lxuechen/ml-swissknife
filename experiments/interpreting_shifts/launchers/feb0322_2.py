...
purpose:
    Working set (classes with smallest marginals == classes most at the tails)
        ...
        increase eta1 and eta2 to be very large (10)
        eta_src moderately small is okay

    Test robustness of these experiments.
    Vary batch size, train epochs, match epochs, seeds.

notes:
run:
    python -m interpreting_shifts.launchers.feb0322_2
"""
