...
purpose:
    ...
    Feature learning, increase eta1

notes:
run:
    python -m interpreting_shifts.launchers.jan2722_2
"""
...
def _get_command(
    ...
    train_dir = utils.join(
        ...
        f'reg_source_{reg_source_str}_'
        f'reg_target_{reg_target_str}_'
        f'reg_entropy_{reg_entropy_str}_'
        f'eta1_{eta1_str}_'
        f'eta2_{eta2_str}_'
        f'seed_{seed:06}'
    )
